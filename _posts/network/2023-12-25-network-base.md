...
위에서 나온 것 처럼 호스트(노드), 교환기, 게이트 웨이 간의 연결이된 모습을 볼 수 있다. 교환기는 위와 같이 호스트 사이를 연결하여 통신을 도와주고, 게이트 웨이는 네트워크 간의 연결을 통해 A 네트워크의 호스트와 B 네트워크의 호스트 간의 통신을 도와준다. 그렇다고 호스트와 호스트간 1:1 통신만 이뤄지는 것은 아니고, 1:N, N:M 통신도 이루어질 수 있다. 교환기는 각 호스트들의 메세지를 저속으로 받고, 고속으로 다른 교환기에 전송한다. 이때 교환기가 모든 메세지를 동시에 처리할 수 없기 때문에 아래와 같이 시분할, 주파수 분할, 통계적 시분할 방식 등으로 처리한다.

**교환기 통신**

<p align="center">
<img width="654" alt="Screenshot 2024-03-09 at 4 05 28 PM" src="https://github.com/rha6780/rha6780.github.io/assets/47859845/9641a947-49cf-4c08-aa83-d131ab789cdf">
</p>
...
<p align="center">
<img width="600" alt="Screenshot_2023-12-25_at_11 50 43_PM" src="https://github.com/rha6780/rha6780.github.io/assets/47859845/b8b20af6-20aa-42aa-9201-d033c6ee2a17">
</p>

- PAN ( Personal Area Network ) : 가장 작은 규모의 초 근거리 네트워크(블루투스 등)
